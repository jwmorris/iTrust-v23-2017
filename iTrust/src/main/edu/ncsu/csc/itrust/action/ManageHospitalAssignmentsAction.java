...
public class ManageHospitalAssignmentsAction {
	...
	public String assignHCPToHospital(String midString, String hospitalID) throws ITrustException {
		try {
			...
			if (confirm) {
			    TransactionLogger.getInstance( factory ).logTransaction(TransactionType.LHCP_ASSIGN_HOSPITAL, loggedInMID, hcpID, "");
	...
	public String removeHCPAssignmentToHospital(String midString, String hospitalID) throws ITrustException {
		try {
			...
			if (confirm) {
			    TransactionLogger.getInstance( factory ).logTransaction(TransactionType.LHCP_REMOVE_HOSPITAL, loggedInMID, hcpID, "");
